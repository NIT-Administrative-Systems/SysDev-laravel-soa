...
class VerifyEventHubHMACTest extends BaseTestCase
{
    ...
    public function test_valid_signature_pass_through()
    {
        ...
        $response = $this->postJson(__METHOD__, ['application_id' => 12345], [$this->header_name => 'f194cd675cc3ebb9f8bf60396a372860e4efcb7c578b8eb76deb3c222bac902b']);
        $response->assertOk();
    ...
    public function test_invalid_signature_401_unauthorized()
    {
        ...
        $response = $this->postJson(__METHOD__, ['application_id' => 12345], [$this->header_name => 'c29973c4e84c0edf5b4e601506ff63ce95baffc9ecc9e287cb0580cfbb243b7a']);
